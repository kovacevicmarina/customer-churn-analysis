...
This project analyses customer churn patterns, revenue impact, and customer risk segmentation across 10,000 customers using Excel, MySQL, and Power BI.
...
Key Findings
1.	Overall churn rate is 18.71%, affecting 1,871 out of 10,000 customers
2.	Basic plan customers churn the most (24.52%), compared to ~16% for Premium and Enterprise
3.	Early-stage customers (0–12 months) have the highest churn (~30%), vs ~10% for long-term customers
4.	Customers with 9+ support calls have a churn rate above 30%, compared to less than 10% for customers with fewer than 5 calls
5.	Payment method has minimal impact on churn behaviour
...
Improve onboarding, early engagement, and retention campaigns in the first 3–6 months
•	Low-Value Customers Churn More
Introduce upgrade incentives or improve the value proposition of the Basic plan
•	High Support Interaction = High Churn Risk
Improve support quality, reduce response time, and resolve recurring issues
•	Revenue Risk Concentration
Focus retention efforts on high-value and high-risk customers
•	Enterprise Customers Drive Revenue Stability
Invest in loyalty programs and dedicated account management
